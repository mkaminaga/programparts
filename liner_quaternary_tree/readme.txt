...
The serial number is used to reduce the patrol path in the collision list
...
reclusive method. My tree patrol is implemented without the reclusive method, so
